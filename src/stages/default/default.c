...
void Back_Default_DrawBG(StageBack *back)
{
	Back_Default *this = (Back_Default*)back;
...
void Back_Default_Free(StageBack *back)
{
	Back_Default *this = (Back_Default*)back;
...
StageBack *Back_Default_New(void)
{
	//Allocate background structure
	Back_Default *this = (Back_Default*)Mem_Alloc(sizeof(Back_Default));
	if (this == NULL)
		return NULL;
	...
	this->back.draw_bg = Back_Default_DrawBG;
	this->back.free = Back_Default_Free;
	
	//Load background textures
	IO_Data arc_back = IO_Read("\\STAGES\\DEFAULT.ARC;1");
